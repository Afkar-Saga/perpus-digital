      ...
      <div class="row justify-content-center">
        <div class="col-md-8 col-sm-10">
          <Form @submit-event.once="addBook" button-value="Tambah" :button-disabled="disableButton">
            ...
            <div class="row mb-3">
              <div class="col">
                <input v-model.number="form.tahun_terbit" type="number" min="1900" max="2099" class="form-control" placeholder="Tahun Terbit">
              </div>
            </div>
            <div class="row mb-3">
              <div class="col">
            ...
            <div class="row mb-3">
              <div class="col">
                <select v-model="form.kategori" class="form-control form-select" :class="{ 'text-muted': !form.kategori }">
                  <option value="" disabled>Kategori</option>
                  <option class="text-black" v-for="category in categories" :key="category.id" :value="category.id">{{ category.nama }}</option>
                </select>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col">
                <select v-model="form.rak" class="form-control form-select" :class="{ 'text-muted': !form.rak }">
                  ...
                  <option class="text-black" v-for="shelf in shelves" :key="shelf.id" :value="shelf.id">{{ shelf.kode_rak }} | {{ shelf.nama }}</option>
                </select>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col">
                ...
                <input type="file" accept="image/*" :disabled="!form.kategori" class="form-control" id="cover" @change="coverPicked">
              </div>
            </div>
