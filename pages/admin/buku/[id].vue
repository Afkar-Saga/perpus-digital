    ...
    <div v-if="showEditForm" class="row justify-content-center">
      <div class="col-md-8 col-sm-10">
        <Form @submit-event.once="editBook" button-value="Edit" :button-disabled="disableButton">
          ...
          <div class="row mb-3">
            <div class="col">
              <textarea v-model.trim="book.deskripsi" class="form-control" rows="3" placeholder="Deskripsi"></textarea>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col">
      ...
      <div class="modal-dialog">
        <div class="modal-content bg-dark text-light">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-danger" data-bs-dismiss="modal" :disabled="deleteStatus == 'pending'"
              @click="deleteBook">Hapus Buku</button>
          </div>
        </div>
      </div>
    </div>
