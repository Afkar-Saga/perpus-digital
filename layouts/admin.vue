<template>
  <div>
    <div class="wrapper">
      <Header>
        <li v-if="['admin', 'admin-kelola-buku', 'admin-statistik'].includes(route.name as string)" class="nav-item">
          <NavPill name="LOGOUT" color="linear-gradient(#CE2828, #BB1313)" border-style="1px solid #810000" destination="/" />
        </li>
        <ul class="navbar-nav flex-fill justify-content-around align-items-center" v-if="['admin-kelola-buku', 'admin-statistik'].includes(route.name as string)">
          <li class="nav-item">
